...
- 입력: "/sd-plan .tasks/test-project/1.1-업무생성편집.md"
- 사전 조건:
  - `.tasks/test-project/1.1-업무생성편집.md` — 요구명세(Gherkin) 포함, 구현계획 없음
- 체크리스트:
...
- 입력: "/sd-plan .tasks/test-project/1.3-업무담당자지정.md"
- 사전 조건:
  - `.tasks/test-project/1.3-업무담당자지정.md` — 요구명세에 기술 선택이 모호한 Gherkin 포함
- 체크리스트:

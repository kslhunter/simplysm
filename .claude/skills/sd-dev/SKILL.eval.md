...
### 시나리오 1: Feature 문서 없음 → Phase 1 (sd-dev-spec) 시작
...
### 시나리오 2: 요구명세만 있는 Feature 문서 → Phase 2 (sd-dev-plan) 시작
- 입력: "/sd-dev .tasks/test-project/1.1-task-create-edit.md"
- 사전 조건:
...
- [ ] Phase 3의 TDD 진행이 sd-dev-tdd의 프로세스 구조(Step A: Acceptance Test Red → Step B: Inner Loop Unit TDD → Step C: Outer Loop Refactor)를 따르지 않는다

...
flowchart TD
    ...
    S2a -->|문서 없음| P1[Phase 1: sd-spec]
    S2a -->|요구명세만 있음| P2[Phase 2: sd-plan]
    S2a -->|요구명세 + 구현계획 있음| S2b[체크박스 기반 세부 상태 복원]
    S2b --> P3[Phase 3: sd-tdd]

    S1seed --> P1

    P1 -->|요구명세 완성| P2
    P2 -->|구현계획 완성| P3
    P3 -->|모든 Slice 완료| S3{wbs.md 존재?}
...
`.claude/skills/sd-spec/SKILL.md`를 Read 도구로 읽고 그대로 따른다.

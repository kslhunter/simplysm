...
| 축 | 기준 |
|----|------|
| **근본성** | 원인을 얼마나 완전히 해결하는가? 증상 숨기기는 저점 |
| **안전성** | 부작용과 회귀 위험이 낮은가? |
| **구현복잡도** | 구현과 유지보수가 간단한가? 복잡할수록 저점 |

합계 = 근본성 + 안전성 + 구현복잡도 (30점 만점)

### 경쟁 규칙

- **모든 방안에 반론 필수** — 반론이 없는 방안은 검증되지 않은 것이다
- **동점 금지** — 합계가 같으면 근본성으로 결정, 그래도 같으면 안전성으로 결정
...
- **장점:** {강점}
- **반론:** {약점/리스크}
- **점수:** 근본성 {N}/10 · 안전성 {N}/10 · 구현복잡도 {N}/10 → **합계 {N}/30**

...
3개 도구를 실행한다. jadx, apktool, dex2jar는 서로 독립적이므로 병렬 실행이 가능하다.
...
```bash
# dex2jar: DEX → JAR (Git Bash에서는 ";"로 classpath를 직접 구성)
_classpath="."

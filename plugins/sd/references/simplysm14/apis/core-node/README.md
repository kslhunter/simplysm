...
- **cpx** — 외부 명령 실행 결과를 stdout/stderr 문자열과 exitCode 로 받고, OS 콘솔 인코딩을 보정해야 할 때. 자세히: [cpx.md](./cpx.md)
...
- **FsWatcher** — chokidar 감시 이벤트를 대상 glob 으로 다시 필터링하고, 짧은 시간의 변경을 병합해 콜백 1회로 처리할 때. 자세히: [fs-watcher.md](./fs-watcher.md)

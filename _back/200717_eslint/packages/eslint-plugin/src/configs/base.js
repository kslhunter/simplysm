...
module.exports = {
  ...
  overrides: [
    {
      files: ["*.js", "*.ts", "*.json"],
      extends: ["eslint:all", "plugin:import/errors", "plugin:import/warnings", "plugin:prettier/recommended"],
      rules: {
        // ---------------------------------
        // error
        // ---------------------------------
    ...
    },
    {
      ...
      plugins: ["@typescript-eslint", "@typescript-eslint/tslint", "@simplysm"],
      extends: ["plugin:import/typescript", "plugin:@typescript-eslint/all", "prettier/@typescript-eslint"],
      settings: {
        "import/parsers": {

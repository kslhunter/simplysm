...
import {Column, DbContext, IDbMigration, Queryable, Table} from "@simplysm/sd-orm-common";
...
describe("(common) orm.Queryable2 (QueryableDef => QueryDef)", () => {
  describe("SELECT", () => {
    it("기본적으로 테이블을 조회한다", () => {
      expect(
        new Queryable(db, TestTable)
          .getSelectDef()
      ).to.deep.equal({

...
describe("core.decorator.PropertyGetSetDecoratorBase", () => {
  it("Object 의 Property 위에 놓을 Decorator 를 작성할 수 있으며, 각 Property 의 get 및 before/after set 에 따른 이벤트를 받아 처리할 수 있다.", () => {
    ...
    function TestPropertyDecorator(): any {
      return PropertyGetSetDecoratorBase(testDecoratorArg);
    }
  ...
  it("복수의 Decorator 가 존재할 경우, 각 Decorator 의 set 동작이 모두 수행된다.", () => {
    ...
    function Test2PropertyDecorator(): any {
      return PropertyGetSetDecoratorBase(test2DecoratorArg);
    }

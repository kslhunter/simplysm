import {ArgumentError, CustomError, DateOnly, DateTime, Time, TimeoutError, Uuid} from "@simplysm/sd-core-common";
import {expect} from "chai";

describe("core.extension.ArrayExtensions", () => {
  describe("single", () => {
  ...
  describe("ofType", () => {
    ...
    it("특정 타입의 서브 타입이더라도 추려낸다", () => {
      ...
      expect(arr.ofType(CustomError)).to.deep.equal([
        arr[6],
        arr[7],
        arr[8]
      ]);

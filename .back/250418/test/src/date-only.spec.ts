...
describe("DateOnly", () => {
  it("연도의 시작일자 알아오기", () => {
    ...
    assert.deepEqual(new DateOnly(2025, 2, 1).getWeekSeqStartDate(0, 1), new DateOnly(2025, 1, 26));
    assert.deepEqual(new DateOnly(2025, 2, 1).getWeekSeqStartDate(1, 1), new DateOnly(2025, 1, 27));
    assert.deepEqual(new DateOnly(2025, 2, 1).getWeekSeqStartDate(2, 1), new DateOnly(2025, 1, 28));
    assert.deepEqual(new DateOnly(2025, 2, 1).getWeekSeqStartDate(3, 1), new DateOnly(2025, 1, 29));
    assert.deepEqual(new DateOnly(2025, 2, 1).getWeekSeqStartDate(4, 1), new DateOnly(2025, 1, 30));
    assert.deepEqual(new DateOnly(2025, 2, 1).getWeekSeqStartDate(5, 1), new DateOnly(2025, 1, 31));
    assert.deepEqual(new DateOnly(2025, 2, 1).getWeekSeqStartDate(6, 1), new DateOnly(2025, 2, 1));
  });

  it("특정일자가 몇년도에 있는 주차인지 알아보기", () => {
    assert.deepEqual(new DateOnly(2024, 12, 29).getBaseYearMonthSeqForWeekSeq(0, 4), {
      year: 2025,
      month: 1,
    });
    assert.deepEqual(new DateOnly(2025, 1, 8).getBaseYearMonthSeqForWeekSeq(0, 4), {
      year: 2025,
      month: 1,
    });
    assert.deepEqual(new DateOnly(2025, 1, 11).getBaseYearMonthSeqForWeekSeq(0, 4), {
      year: 2025,
      month: 1,
    });
    assert.deepEqual(new DateOnly(2025, 12, 28).getBaseYearMonthSeqForWeekSeq(0, 4), {
      year: 2025,
      month: 12,
    });
    assert.deepEqual(new DateOnly(2026, 1, 1).getBaseYearMonthSeqForWeekSeq(0, 4), {
      year: 2025,
      month: 12,
    });
  });
  ...
  it("특정일자가 연도상 몇주차 알아오기", () => {
    assert.deepEqual(new DateOnly(2024, 12, 29).getWeekSeqOfYear(0, 4), { year: 2025, weekSeq: 1 });
    ...
    assert.deepEqual(new DateOnly(2025, 12, 28).getWeekSeqOfYear(0, 4), {
      year: 2025,
      weekSeq: 53,
    });
  ...
  it("특정일자가 연월의 몇주차 알아오기", () => {
    assert.deepEqual(new DateOnly(2024, 12, 29).getWeekSeqOfMonth(0, 4), {
      year: 2025,
      month: 1,
      weekSeq: 1,
    });
    assert.deepEqual(new DateOnly(2025, 1, 8).getWeekSeqOfMonth(0, 4), {
      year: 2025,
      month: 1,
      weekSeq: 2,
    });
    assert.deepEqual(new DateOnly(2025, 1, 11).getWeekSeqOfMonth(0, 4), {
      year: 2025,
      month: 1,
      weekSeq: 2,
    });
    assert.deepEqual(new DateOnly(2025, 1, 12).getWeekSeqOfMonth(0, 4), {
      year: 2025,
      month: 1,
      weekSeq: 3,
    });
    assert.deepEqual(new DateOnly(2025, 12, 28).getWeekSeqOfMonth(0, 4), {
      year: 2025,
      month: 12,
      weekSeq: 5,
    });
    assert.deepEqual(new DateOnly(2026, 1, 1).getWeekSeqOfMonth(0, 4), {
      year: 2025,
      month: 12,
      weekSeq: 5,
    });
    assert.deepEqual(new DateOnly(2026, 1, 3).getWeekSeqOfMonth(0, 4), {
      year: 2025,
      month: 12,
      weekSeq: 5,
    });
    assert.deepEqual(new DateOnly(2026, 1, 4).getWeekSeqOfMonth(0, 4), {
      year: 2026,
      month: 1,
      weekSeq: 1,
    });

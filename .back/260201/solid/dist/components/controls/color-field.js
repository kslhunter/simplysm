...
const ColorField = (props) => {
  ...
  return /* @__PURE__ */ React.createElement(
    ...
    /* @__PURE__ */ React.createElement("div", { class: colorFieldContainer }, /* @__PURE__ */ React.createElement("div", { class: colorFieldContent, style: { background: inputValue() } }), /* @__PURE__ */ React.createElement(
      "input",
      {
        ...rest,
        ...inputProps(),
        class: [colorFieldInput, colorField(objPick(local, colorField.variants())), local.class].filterExists().join(" ")
      }
    ))
  );
};

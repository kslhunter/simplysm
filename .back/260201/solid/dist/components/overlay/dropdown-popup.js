...
const DropdownPopup = (props) => {
  ...
  const handleKeyDown = (e) => {
    ...
    if (!e.ctrlKey && !e.altKey) {
      ...
      const shouldFocusTrigger = ctx.placement() === "bottom" && e.key === "ArrowUp" && document.activeElement === tabbables[0] || ctx.placement() === "top" && e.key === "ArrowDown" && document.activeElement === tabbables.at(-1);
  ...
  return /* @__PURE__ */ React.createElement(Show, { when: ctx.open() }, /* @__PURE__ */ React.createElement(Portal, null, /* @__PURE__ */ React.createElement(Show, { when: ctx.isMobile() }, /* @__PURE__ */ React.createElement("div", { class: backdrop, onClick: () => ctx.close() })), /* @__PURE__ */ React.createElement(
    "div",
    {
      ref: popupRef,
    ...
    /* @__PURE__ */ React.createElement(Show, { when: ctx.isMobile() && showHandle() }, /* @__PURE__ */ React.createElement("div", { class: mobileHandle })),

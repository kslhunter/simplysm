...
> **읽어야 하는 상황**: DbContext를 정의하여 테이블/프로시저를 등록하고, DB 연결/트랜잭션/DDL/초기화를 관리할 때. 쿼리 구성은 [`Queryable`](../queryable-executable/queryable.md), 표현식 작성은 [`expr`](../expression/expr.md) 참조.

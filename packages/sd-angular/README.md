...
| 파일명 | 설명 | [⚠️](#Deprecated) |
|----------|------|:------------:|
| base/sd-modal-base.control.ts | 모달의 기본 구조와 권한 체크를 제공하는 컨트롤 | |
| base/sd-page-base.control.ts | 페이지의 기본 구조를 제공하는 컨트롤 | |
| sd-base-container.control.ts | 기본 컨테이너 컨트롤 | ⚠️ |
| sd-permission-table.control.ts | 권한 관리 테이블 컨트롤 | |
| shared-data/sd-shared-data.provider.ts | 공유 데이터 관리 프로바이더 | |
...
| 파일명 | 설명 | [⚠️](#Deprecated) |
|----------|------|:------------:|
| barcode/sd-barcode.control.ts | 바코드 생성 컨트롤 | |
| barcode/sd-qrcode.control.ts | QR코드 생성 컨트롤 | |
| busy/sd-busy.provider.ts | 로딩 상태 관리 프로바이더 | |
| busy/sd-busy-container.control.ts | 로딩 상태 표시 컨테이너 컨트롤 | |
| button/sd-additional-button.control.ts | 추가 버튼 컨트롤 | |
| button/sd-anchor.control.ts | 앵커 링크 컨트롤 | |
| button/sd-button.control.ts | 기본 버튼 컨트롤 | |
| card/sd-card.control.ts | 카드 레이아웃 컨트롤 | |
...
| form-layout/sd-form-box.control.ts | 폼 박스 레이아웃 컨트롤 | |
| form-layout/sd-form-box-item.control.ts | 폼 박스 아이템 레이아웃 컨트롤 | |
| form-layout/sd-form-table.control.ts | 폼 테이블 레이아웃 컨트롤 | |
| icon/sd-icon.control.ts | 아이콘 표시 컨트롤 | |
| icon/sd-icon-layers.control.ts | 아이콘 레이어 컨트롤 | |
| icon/sd-icon-stack.control.ts | 아이콘 스택 컨트롤 | |
| input/sd-range.control.ts | 범위 선택 입력 컨트롤 | |
| input/sd-textarea.control.ts | 여러 줄 텍스트 입력 컨트롤 | |
| input/sd-textfield.control.ts | 한 줄 텍스트 입력 컨트롤 | |
| kanban/sd-kanban.control.ts | 칸반 보드 컨트롤 | |
| kanban/sd-kanban-board.control.ts | 칸반 보드 레이아웃 컨트롤 | |
| kanban/sd-kanban-lane.control.ts | 칸반 레인 컨트롤 | |
| label/sd-label.control.ts | 라벨 표시 컨트롤 | |
| layout/sd-dock.control.ts | 도킹 레이아웃 컨트롤 | |
| layout/sd-dock-container.control.ts | 도킹 컨테이너 컨트롤 | |
| layout/sd-gap.control.ts | 간격 조절 컨트롤 | |
| layout/sd-grid.control.ts | 그리드 레이아웃 컨트롤 | |
...
| table/sd-table.control.ts | 테이블 데이터 표시 컨트롤 | |
| theme/sd-theme.provider.ts | 테마 관리 프로바이더 | |
| theme/sd-theme-selector.control.ts | 테마 선택 컨트롤 | |
| toast/sd-toast.control.ts | 토스트 메시지 컨트롤 | |
| toast/sd-toast.provider.ts | 토스트 메시지 관리 프로바이더 | |
| toast/sd-toast-container.control.ts | 토스트 메시지 컨테이너 컨트롤 | |
...
| 파일명 | 설명 | [⚠️](#Deprecated) |
|----------|------|:------------:|
| sd-animation-delay.directive.ts | 애니메이션 지연 효과 디렉티브 | |

...
@Component({
  ...
  template: `
    ...
    <div class="_icon" *ngIf="!disabled">
      <fa-icon [fixedWidth]="true" [icon]="icons.fasCaretDown"></fa-icon>
    </div>
...
export class SdComboboxComponent implements OnInit, OnDestroy, AfterContentChecked {
  public icons = { fasCaretDown };
  ...
  @ContentChildren(SdComboboxItemComponent, { descendants: true })
  public itemControls?: QueryList<SdComboboxItemComponent>;
  ...
  private readonly _iterableDiffer: IterableDiffer<SdComboboxItemComponent>;
  ...
  public setValueFromItemControl(value: any, itemControl: SdComboboxItemComponent): void {
    if (this.value !== value) {
      if (this.valueChange.observers.length > 0) {

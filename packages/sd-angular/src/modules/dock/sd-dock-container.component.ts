...
export class SdDockContainerComponent implements AfterContentInit {
  @Input()
  @SdInputValidate({ type: Boolean, notnull: true })
  @HostBinding("attr.sd-float")
  public float = false;

  @ContentChildren(forwardRef(() => SdDockComponent))
  public dockControls?: QueryList<SdDockComponent>;

...
import { ISdSheetColumnConfigVM } from "./sd-sheet.component";
...
export class SdSheetConfigModalComponent extends SdModalBase<ISdSheetConfigModalInput, Record<string, ISdSheetColumnConfigVM>> {
...
export interface ISdSheetConfigModalInput {
  controls: SdSheetColumnComponent[];

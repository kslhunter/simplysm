...
import fasCog from "@fortawesome/pro-solid-svg-icons/faCog";
import fasSort from "@fortawesome/pro-solid-svg-icons/faSort";
import fasSortDown from "@fortawesome/pro-solid-svg-icons/faSortDown";
import fasSortUp from "@fortawesome/pro-solid-svg-icons/faSortUp";
import fasArrowRight from "@fortawesome/pro-solid-svg-icons/faArrowRight";
import fasCaretRight from "@fortawesome/pro-solid-svg-icons/faCaretRight";
      ...
      <sd-dock *ngIf="(key || pageLength > 0) && !hideConfigBar">
        <div class="_icon-container">
          <sd-anchor class="_card-icon"
            ...
            <fa-icon [icon]="displayType === 'card' ? 'bars' : 'table'" [fixedWidth]=true></fa-icon>
          </sd-anchor>
...
export class SdSheetComponent implements DoCheck, OnInit, AfterContentChecked {
  public icons = {
    fasBars,
    fasTable,
    fasCog,
  ...
  @ContentChildren(forwardRef(() => SdSheetColumnComponent))
  public columnControls?: QueryList<SdSheetColumnComponent>;
  ...
  public getIsEditCell(index: number, columnControl: SdSheetColumnComponent): boolean {
  ...
  public fixedColumnControls: SdSheetColumnComponent[] = [];
  public nonFixedColumnControls: SdSheetColumnComponent[] = [];
  ...
  public getColumnChecked(columnControl: SdSheetColumnComponent, item: any): boolean {
  ...
  public setColumnChecked(columnControl: SdSheetColumnComponent, item: any, value: boolean): void {
  ...
  public getIsColumnAllItemChecked(columnControl: SdSheetColumnComponent): boolean {
    if (
  ...
  public setIsColumnAllItemChecked(columnControl: SdSheetColumnComponent, value: boolean): void {
    if (StringUtil.isNullOrEmpty(columnControl.key)) return;
  ...
  private _getColumnControlsOfFixType(fixed: boolean): SdSheetColumnComponent[] {
  ...
  private _getIsGroupLastColumn(columnControl: SdSheetColumnComponent): boolean {
  ...
  private _getColumnWidthPixel(columnControl: SdSheetColumnComponent): number {
    if (
      this.key !== undefined
  ...
  public trackByFnForColumnControl = (index: number, item: SdSheetColumnComponent): any => item.guid;
  ...
  private readonly _columnControlsDiffer: IterableDiffer<SdSheetColumnComponent>;
  ...
  public async onConfigButtonClick(): Promise<void> {
    const result = await this._modal.showAsync(SdSheetConfigModalComponent, "시트 설정창", {
  ...
  public onHeadCellBorderMousedown(event: MouseEvent, columnControl: SdSheetColumnComponent): void {
  ...
  public onColumnOrderingHeaderClick(event: MouseEvent, columnControl: SdSheetColumnComponent): void {
  ...
  private _getHeaderGroups(columnControls: SdSheetColumnComponent[]): { name?: string; widthPixel: number }[] {

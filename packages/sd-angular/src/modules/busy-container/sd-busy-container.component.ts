...
import { SdBusyContainerService } from "../../services/busy-container";
...
export class SdBusyContainerComponent {
  @Input()
  ...
  public constructor(private readonly _busy: SdBusyContainerService) {

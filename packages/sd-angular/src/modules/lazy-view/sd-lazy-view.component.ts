...
import { SdToastService } from "../toast";
import { SdLazyViewLoaderService } from "./internal/sd-lazy-view-loader.service";
...
export class SdLazyViewComponent implements OnInit {
  public busyCount = 0;
  ...
  public constructor(private readonly _toast: SdToastService,
                     private readonly _cdr: ChangeDetectorRef,
                     private readonly _lazyPage: SdLazyViewLoaderService) {
  }

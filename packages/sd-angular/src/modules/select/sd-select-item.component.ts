...
export class SdSelectItemComponent implements AfterViewInit, AfterContentChecked, OnDestroy {
  ...
  public constructor(@Inject(forwardRef(() => SdSelectComponent))
                     private readonly _selectControl: SdSelectComponent,

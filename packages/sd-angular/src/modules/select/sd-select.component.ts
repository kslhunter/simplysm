...
import { SdDropdownComponent } from "../dropdown";
...
export class SdSelectComponent implements DoCheck {
  public icons = {
    fasCaretDown
  };
  ...
  public dropdownControl?: SdDropdownComponent;
  ...
  public itemControls: SdSelectItemComponent[] = [];
  ...
  public getIsSelectedItemControl(itemControl: SdSelectItemComponent): boolean {
  ...
  public onItemControlClick(itemControl: SdSelectItemComponent, noClose?: boolean): void {
    if (this.selectMode === "multi") {
  ...
  public onItemControlInit(itemControl: SdSelectItemComponent): void {
  ...
  public onItemControlDestroy(itemControl: SdSelectItemComponent): void {
    if (this.itemControls.includes(itemControl)) {
  ...
  public onItemControlContentChanged(itemControl: SdSelectItemComponent): void {
    if (this.getIsSelectedItemControl(itemControl) || this.getChildrenFn) {
      this._cdr.detectChanges();
    }
  }

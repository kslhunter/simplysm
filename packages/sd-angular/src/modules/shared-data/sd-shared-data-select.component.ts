...
import { ISharedDataBase, SdSharedDataService } from "./sd-shared-data.service";
...
export class SdSharedDataSelectComponent implements OnInit, DoCheck {
  @Input()
  ...
  public constructor(private readonly _sharedData: SdSharedDataService,

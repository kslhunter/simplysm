      ...
      <sd-pane>
        ...
        <div *ngIf="viewState === 'help'" class="_help sd-padding-default">
          <div class="sd-margin-bottom-default">
            ...
            <div class="sd-padding-default sd-background-grey-lightest" style="border-radius: 2px;">
...
export class SdMarkdownEditorControl implements ISdNotifyPropertyChange {
  ...
  @Input()
  @SdTypeValidate({ type: String, includes: ["preview", "edit", "help"] })
  @SdNotifyPropertyChange()
  ...
  public constructor(private readonly _sanitizer: DomSanitizer, private readonly _cdr: ChangeDetectorRef) {}

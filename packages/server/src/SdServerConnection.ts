...
import {ISdServerEmitResponse, ISdServerRequest, ISdServerResponse, JsonConvert, Logger} from "@simplysm/common";

export class SdServerConnection extends EventEmitter {
  ...
  public async sendAsync(data: ISdServerResponse | ISdServerEmitResponse): Promise<void> {

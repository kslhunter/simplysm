...
// import {DateTime, JsonConvert} from "@simplysm/common";

// export type SdSocketServerWebRequestListenerType = (req: http.IncomingMessage, res: http.ServerResponse) => Promise<boolean> | boolean;

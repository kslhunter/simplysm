...
export function Column<T>(columnDef?: {
  ...
  return (object: T, propertyKey: string) => {
    ...
    tableDef.columns.push({
      name: propertyKey,
      dataType: (columnDef && columnDef.dataType),
      nullable: columnDef && columnDef.nullable,
      autoIncrement: columnDef && columnDef.autoIncrement,
      primaryKey: columnDef && columnDef.primaryKey,

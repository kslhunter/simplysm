import { DateOnly, DateTime, JsonConvert, optional, Time, Type, Uuid } from "@simplysm/sd-common";
...
export class QueryHelper {
  public static getFieldQuery(arg: QueryType | QueryUnit<QueryType>): string {
    if (arg instanceof QueryUnit) {
      ...
      throw new TypeError(
        `${optional(() => arg.constructor.name) || typeof arg}: ${arg}: ${JsonConvert.stringify(arg)}`
      );
    }
  }

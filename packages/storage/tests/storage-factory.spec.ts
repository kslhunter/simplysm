...
describe("StorageFactory", () => {
  ...
  describe("connect", () => {
    ...
    it("오류 시 연결을 닫고 오류를 전파해야 함", async () => {
    ...
    it("오류 시 SFTP 연결을 닫고 오류를 전파해야 함", async () => {
      const error = new Error("Test error");
    ...
    it("작업 완료 후 SFTP 연결을 닫아야 함", async () => {
    ...
    it("동시 연결에 대해 독립적으로 동작해야 함", async () => {

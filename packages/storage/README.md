...
스토리지 타입에 따라 적절한 클라이언트를 생성하고 자동으로 연결/종료를 관리합니다.
...
FTP/FTPS 프로토콜을 사용하는 스토리지 클라이언트입니다.

...
export default function CollapsePage() {
  ...
  return (
    <div class="space-y-8 p-6">
      {/* Basic Toggle */}
      <section>
        <h2 class="mb-4 border-l-4 border-primary-500 pl-3 text-lg font-bold">Basic Toggle</h2>
        <div class="space-y-2">
          <Button
            theme="primary"
            variant="solid"
      ...
      <section>
        <h2 class="mb-4 border-l-4 border-primary-500 pl-3 text-lg font-bold">
          Multiple Collapse (Accordion-like)
        </h2>
        <div class="space-y-2">
          <div>
            <Button
      ...
      {/* Initially Open */}
      <section>
        <h2 class="mb-4 border-l-4 border-primary-500 pl-3 text-lg font-bold">Initially Open</h2>
        <div class="space-y-2">
          <Button
            theme="info"
            variant="solid"

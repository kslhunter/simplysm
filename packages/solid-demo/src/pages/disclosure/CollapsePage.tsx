            ...
            <div class="space-y-2">
              ...
              <Collapse id="basic-collapse" open={collapseOpen()}>
                <div class="rounded-lg border border-gray-200 bg-gray-50 p-4 dark:border-gray-700 dark:bg-gray-800">
                  ...
                  <p class="mt-2 text-sm text-gray-600 dark:text-gray-400">The content smoothly animates when toggling.</p>
                </div>
              </Collapse>
            </div>
          </section>
            ...
            <div class="space-y-2">
              <div>
                ...
                <Collapse id="multi-collapse-1" open={multiOpen1()}>
                  <div class="rounded-b-lg border border-t-0 border-gray-200 bg-white p-4 dark:border-gray-700 dark:bg-gray-800">

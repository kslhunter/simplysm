...
export default function CardPage() {
  return (
    <div class="space-y-8 p-6">
      {/* Basic Card */}
      <section>
        <h2 class="mb-4 border-l-4 border-primary-500 pl-3 text-lg font-bold">기본 카드</h2>
        <Card>
          <div class="p-4">
      ...
      {/* Card with Header */}
      <section>
        <h2 class="mb-4 border-l-4 border-primary-500 pl-3 text-lg font-bold">헤더가 있는 카드</h2>
        <Card>
      ...
      {/* Card Grid */}
      <section>
        <h2 class="mb-4 border-l-4 border-primary-500 pl-3 text-lg font-bold">카드 그리드</h2>
      ...
      {/* Interactive Card */}
      <section>
        <h2 class="mb-4 border-l-4 border-primary-500 pl-3 text-lg font-bold">인터랙티브 카드</h2>
      ...
      {/* Card with Image */}
      <section>
        <h2 class="mb-4 border-l-4 border-primary-500 pl-3 text-lg font-bold">이미지 카드</h2>
        <Card>

        ...
        <div class="space-y-8">
              ...
              <SidebarContainer>
                ...
                <main class="h-full overflow-auto p-4">
                  ...
                  <div class="rounded border border-gray-200 bg-gray-50 p-4 dark:border-gray-700 dark:bg-gray-800">
                    <p class="text-sm text-gray-600 dark:text-gray-400">사이드바 메뉴를 클릭하면 해당 경로로 이동합니다.</p>
                  </div>
                </main>
              </SidebarContainer>
            </div>
          ...
          <section>
            ...
            <div class="grid grid-cols-1 gap-6 md:grid-cols-3">
              {/* 없음 */}
              <div>
                <p class="mb-2 text-sm text-gray-600 dark:text-gray-400">없음</p>
                  ...
                  <SidebarContainer>
                    ...
                    <main class="h-full overflow-auto p-4">
                      ...
                      <div class="mt-4 rounded border border-gray-200 bg-gray-50 p-4 dark:border-gray-700 dark:bg-gray-800">
                        <p class="text-sm text-gray-600 dark:text-gray-400">SidebarUser 없음</p>
                      </div>
                    </main>
                  </SidebarContainer>
                </div>
              ...
              {/* 기본 (children만) */}
              <div>
                <p class="mb-2 text-sm text-gray-600 dark:text-gray-400">기본 (children만)</p>
                <div class="h-80 overflow-hidden rounded-lg border border-gray-200 dark:border-gray-700">
                  <SidebarContainer>
                    <Sidebar>
                      <div class="p-2 px-4 font-bold">LOGO</div>
                    ...
                    <main class="h-full overflow-auto p-4">
                      <SidebarToggleButton />
                      <div class="mt-4 rounded border border-gray-200 bg-gray-50 p-4 dark:border-gray-700 dark:bg-gray-800">
                        <p class="text-sm text-gray-600 dark:text-gray-400">메뉴 없이 사용자 정보만 표시</p>
                      </div>
                    </main>
                  </SidebarContainer>
                </div>
                ...
                <div class="h-80 overflow-hidden rounded-lg border border-gray-200 dark:border-gray-700">
                  <SidebarContainer>
                    <Sidebar>
                      ...
                      >
                        <div class="flex items-center gap-3">
                          ...
                          <div class="flex flex-col">
                            <span class="font-semibold">홍길동</span>
                            <span class="text-sm text-gray-500 dark:text-gray-400">admin@example.com</span>
                          </div>
                        </div>
                      </SidebarUser>
                      <SidebarMenu menus={sampleMenuItems} />
                    ...
                    <main class="h-full overflow-auto p-4">
                      <SidebarToggleButton />
                      <div class="mt-4 rounded border border-gray-200 bg-gray-50 p-4 dark:border-gray-700 dark:bg-gray-800">
                        <p class="text-sm text-gray-600 dark:text-gray-400">클릭하면 드롭다운 메뉴 표시</p>
                      </div>
                    </main>
                  </SidebarContainer>
                </div>

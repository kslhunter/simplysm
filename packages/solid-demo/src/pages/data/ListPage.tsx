      ...
      <div class="flex-1 overflow-auto p-6">
        <div class="space-y-8">
          ...
          <section>
            ...
            <p class="mb-2 text-sm text-gray-600 dark:text-gray-400">Selected: {selectedItem() ?? "None"}</p>
            <div class="max-w-md">
              <List>
          ...
          <section>
            ...
            <p class="mb-2 text-sm text-gray-600 dark:text-gray-400">Use Arrow keys to navigate, Arrow Right/Left to expand/collapse</p>
            <div class="max-w-md">
              <List>
                <ListItem open={treeOpen1()} onOpenChange={setTreeOpen1}>
                  ...
                  <ListItem.Children>
                    <ListItem onClick={() => alert("Report.pdf")}>
                      <Icon icon={IconFile} class="mr-2 text-gray-500 dark:text-gray-400" />
                      Report.pdf
                    </ListItem>

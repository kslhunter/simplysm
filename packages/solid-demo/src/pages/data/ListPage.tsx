...
import { Icon, List } from "@simplysm/solid";
import {
  IconCheck,
  IconFile,
  IconFolder,
...
export default function ListPage() {
  ...
  return (
    <div class="space-y-8 p-6">
      {/* Basic List */}
      <section>
        <h2 class="mb-4 border-l-4 border-primary-500 pl-3 text-lg font-bold">Basic List</h2>
        <List>
      ...
      {/* Selectable List */}
      <section>
        <h2 class="mb-4 border-l-4 border-primary-500 pl-3 text-lg font-bold">Selectable List</h2>
      ...
      {/* List with Icons */}
      <section>
        <h2 class="mb-4 border-l-4 border-primary-500 pl-3 text-lg font-bold">List with Icons</h2>
        <List>
      ...
      {/* Inset Style */}
      <section>
        <h2 class="mb-4 border-l-4 border-primary-500 pl-3 text-lg font-bold">Inset Style</h2>
        <List inset>

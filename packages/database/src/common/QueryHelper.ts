...
export class QueryHelper {
    static convertToDataType(type: Type<any>): DataType {
        switch (type) {
            case String:
    ...
    static convertFromDataType(type: DataType | string): Type<any> {
    ...
    static convertToSqlType(type: DataType): mssql.ISqlTypeFactory {
        switch (type) {
    ...
    static escapeKey(...keys: string[]): string {

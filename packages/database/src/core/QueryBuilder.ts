import {
    IColumnDefinition, IFunctionDefinition, IIndexDefinition, IPrimaryKeyColumnDefinition,
...
`;
    ...
    static createPrimaryKey(tableName: string,
    ...
    static createIndex(tableName: string,
    ...
    static createForeignKey(tableName: string, foreignKey: {
        name: string;
        columnNames: string[];
...
`;
    ...
    static createFunction(def: IFunctionDefinition): string {
        if (!def.returnType) {
...
END`;
    ...
    static createProcedure(def: IStoredProcedureDefinition): string {
        const q = `

...
export class SdModalProvider {
  ...
  public async show<T extends SdModalBase<any, any>>(modalType: Type<T>, title: string, param: T["_tParam"],
                                                     option?: { hideCloseButton?: boolean; float?: boolean; minHeight?: string; useCloseByBackdrop?: boolean }): Promise<T["_tResult"] | undefined> {

...
import type { SdPermission } from "../../core/providers/sd-app-structure.types";
import { SdCheckbox } from "../../ui/form/checkbox/sd-checkbox";
import { SdCollapseIcon } from "../../ui/navigation/collapse/sd-collapse-icon";

...
import { SdLabelDefaultTest, SdLabelColorTest } from "./sd-label-test.fixture";
import { SdNoteDefaultTest } from "./sd-note-test.fixture";

describe("Feature 2.6 Slice 1: sd-label", () => {
  it("color=#ff0000이면 style.background-color에 커스텀 색상이 적용된다", () => {
    const fixture = TestBed.configureTestingModule({ imports: [SdLabelColorTest] }).createComponent(
      SdLabelColorTest,
    );

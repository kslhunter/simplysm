...
describe("NumberField", () => {
  ...
  describe("값 변환", () => {
    ...
    it("소수점이 포함된 숫자를 올바르게 표시한다", () => {
      render(() => <NumberField value={1234.56} />);
    ...
    it("입력 중에 올바르게 동작한다", () => {
      ...
      render(() => <NumberField onValueChange={handleChange} />);
    ...
    it("소수점 입력 중인 상태를 유지한다", () => {
      ...
      render(() => <NumberField value={value()} onValueChange={setValue} />);
    ...
    it("유효하지 않은 입력은 무시한다", () => {
      const handleChange = vi.fn();
      render(() => <NumberField value={100} onValueChange={handleChange} />);
  ...
  describe("표시 형식", () => {
    ...
    it("minDigits로 최소 소수점 자릿수를 지정할 수 있다", () => {
      render(() => <NumberField value={100} minDigits={2} />);
    ...
    it("minDigits보다 긴 소수점은 그대로 표시한다", () => {
      render(() => <NumberField value={100.12345} minDigits={2} />);
  ...
  describe("disabled/readonly 상태", () => {
    ...
    it("readonly 상태에서는 div로 렌더링한다", () => {
      render(() => <NumberField value={5678} readonly />);
  ...
  describe("스타일 옵션", () => {
    it("size='sm'일 때 작은 패딩이 적용된다", () => {
      const { container } = render(() => <NumberField size="sm" />);
  ...
  describe("placeholder", () => {
    it("placeholder를 표시한다", () => {
      render(() => <NumberField placeholder="숫자를 입력하세요" />);

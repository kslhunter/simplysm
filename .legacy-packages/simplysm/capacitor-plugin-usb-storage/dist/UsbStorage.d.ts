...
export declare abstract class UsbStorage {
   ...
   * @returns 권한 승인 여부
   */
  static requestPermission(filter: { vendorId: number; productId: number }): Promise<boolean>;
  /**
   * USB 장치 접근 권한이 있는지 확인
   * @param filter 권한을 확인할 USB 장치의 vendorId와 productId
   * @returns 권한 보유 여부
   */
  static hasPermission(filter: { vendorId: number; productId: number }): Promise<boolean>;
  /**

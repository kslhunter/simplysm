 ...
 */
export class CordovaUsbStorage {
    /**
     * 연결된 USB 장치 목록을 가져옴
    ...
    static async requestPermission(filter) {
        return await new Promise((resolve, reject) => {
            cordova.exec((res) => {
                ...
                reject(new Error("CORDOVA: ERROR: " + err));
            }, "CordovaUsbStorage", "requestPermission", [filter.vendorId, filter.productId]);
        });
    }
    /**
    ...
    static async hasPermission(filter) {
        return await new Promise((resolve, reject) => {
            cordova.exec((res) => {
                ...
                reject(new Error("CORDOVA: ERROR: " + err));
            }, "CordovaUsbStorage", "hasPermission", [filter.vendorId, filter.productId]);
        });
    }
    /**
    ...
    static async readdir(filter, dirPath) {
        return await new Promise((resolve, reject) => {
            cordova.exec((res) => {
                ...
                reject(new Error("CORDOVA: ERROR: " + err));
            }, "CordovaUsbStorage", "readdir", [filter.vendorId, filter.productId, dirPath]);
        });
    }
    /**
     * USB 저장장치의 파일을 읽어옴
    ...
    static async read(filter, filePath) {
        return await new Promise((resolve, reject) => {
            cordova.exec((res) => {
                ...
                reject(new Error("CORDOVA: ERROR: " + err));
            }, "CordovaUsbStorage", "read", [filter.vendorId, filter.productId, filePath]);
        });
    }
}
//# sourceMappingURL=CordovaUsbStorage.js.map